...
**Not yet verified on real hardware** — same caveat as the SF10 rule above; this was wired and coded but not bench-tested as of this pass. Confirm the card actually mounts (`[OK] SD card logging active` in the serial dump) and that a pulled card produces real CSV rows before trusting it in the field.
...
## Current State (V3.7 — SF10 CONFIRMED to hang real hardware too, reverted to SF7)
